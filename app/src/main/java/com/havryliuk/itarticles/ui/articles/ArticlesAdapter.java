...
public class ArticlesAdapter extends BaseRecyclerViewAdapter<ArticlesAdapter.ViewHolder, DouArticle> {
    ...
    public ArticlesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ArticlesAdapter.ViewHolder(
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.imageView.setImageURI(
             Uri.parse(articleImage.isEmpty() ? douArticle.getImgSmall() : douArticle.getImgBig()));
